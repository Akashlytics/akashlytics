...
$srcFolder="C:\Users\max_m\OneDrive\Documents\docker\akash-proto-gen\proto\akash-master\proto\"
...
$protoFilePath="C:\Users\max_m\OneDrive\Documents\docker\akash-proto-gen\proto\akash-master\proto\akash\cert\v1beta2\cert.proto"
...
Foreach ($file in $protoFilesLocal)
{
    ...
    If ($msgMatches.Count -gt 0){
        $msgDefs = $msgMatches | Foreach { "[""/$($fileNameNoExt.Replace("\",".")).$($_.Groups["msg"])"",$($varName).$($_.Groups["msg"])]" }
